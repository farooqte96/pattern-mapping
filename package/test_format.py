...
class TestIntegers(unittest.TestCase):
   ...
   """
    ...
    def test_return_true_if_all_integers_positive(self):
        ...
        result = user_input.if_numbers_within_bounds(integers)
...
class TestStringPatterns(unittest.TestCase):
    ...
    def test_pattern_SST_with_5_should_give_SSTSS(self):
        pattern = 'sst'
        integer = 5
        modified_pattern = modify_string.modify_string(pattern, integer)
    ...
    def test_retrieve_message_all_strings(self):
        ...
        retrieved_message = retrieve_message.get_message_of_all_strings(pattern)
    ...
    def test_retrive_message_single_string(self):
         ...
         retrieved_message = retrieve_message.get_message_single_string(single_string)
    ...
    def test_string_beyond_20_characters_should_return_empty_string(self):
        ...
        retrieved_message = retrieve_message.get_message_single_string(bigger_string)
    ...
    def test_check_apply_format(self):
        test_string = 'ssttsts'
        integer_list = [5, 3, 2]
        result = apply_format.apply_format(test_string, integer_list)
